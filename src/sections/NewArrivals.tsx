    ...
    >
      ...
      >
        ...
        <div className="relative aspect-[3/4] overflow-hidden">
          ...
          {/* Badge */}
          <span
            className={`absolute top-4 left-4 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-[0.2em] shadow-lg ${
              product.badge === "Hot"
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-[#0a1628]/60 backdrop-blur-sm z-10">
            <div className="flex items-center gap-2 px-6 py-3 rounded-full border-[2px] border-[#c9a84c] bg-[#0a1628]/80 shadow-[0_0_20px_rgba(201,168,76,0.4)]">
              <Eye className="w-5 h-5 text-[#c9a84c]" />
              <span className="text-sm text-white font-black uppercase tracking-[0.2em]">
                Quick View
              </span>
            </div>
          </div>
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <button className="group flex items-center gap-2 px-6 py-3 rounded-full border-2 border-[#c9a84c] text-sm text-[#c9a84c] font-black uppercase tracking-widest hover:bg-[#c9a84c] hover:text-[#0a1628] transition-all cursor-pointer shadow-[0_0_15px_rgba(201,168,76,0.2)]">
