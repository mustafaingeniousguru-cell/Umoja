    ...
    >
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid grid-cols-3 items-center">
          ...
          <nav className="hidden lg:flex items-center gap-10 justify-self-start">
          ...
          <div className="flex items-center gap-6 justify-self-end">
            ...
            <div className="hidden sm:flex items-center gap-5">
              <button className="flex items-center gap-2 text-sm text-white hover:text-[#c9a84c] uppercase tracking-[0.15em] transition-colors duration-300 cursor-pointer">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#c9a84c]/30 text-white hover:bg-[#c9a84c] hover:text-[#0a1628] font-bold text-sm uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer"
              >
                Sign In
              </motion.button>
            </div>
