...
function CountdownBlock({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <div className="w-10 h-10 sm:w-20 sm:h-20 rounded-lg sm:rounded-xl border-[2px] sm:border-[3px] border-[#c9a84c] bg-[#040a14] flex items-center justify-center shadow-[inset_0_5px_15px_rgba(0,0,0,0.8),0_5px_10px_rgba(0,0,0,0.5)]">
        <motion.span
          key={value}
          initial={{ opacity: 0.5, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          className="text-base sm:text-4xl font-black text-white tabular-nums font-mono drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]"
        >
          {value}
        </motion.span>
      </div>
      <span className="text-[7px] sm:text-xs text-white uppercase tracking-[0.1em] sm:tracking-[0.2em] mt-1 sm:mt-3 font-black">
        {label}
      </span>
    </div>
  );
...
export default function TreasureOfTheDaySection() {
    ...
    >
      <div className="w-full max-w-[1000px] mx-auto rounded-[1rem] sm:rounded-[2rem] border-[3px] sm:border-[4px] border-[#c9a84c] bg-[#040a14] shadow-[0_30px_60px_rgba(0,0,0,0.8),inset_0_0_40px_rgba(201,168,76,0.1)] p-4 sm:p-12 relative flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 mt-4 sm:mt-8 z-20 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left relative z-10">
          ...
          <h3 className="text-2xl sm:text-4xl font-black text-white uppercase tracking-wider mb-3">
            Treasure of the Day
          </h3>
          ...
          {/* Countdown */}
          <div className="flex items-center justify-center md:justify-start gap-1 sm:gap-4 mb-5">
        ...
        <div className="flex-1 flex items-center justify-center relative z-10">
          <div className="relative w-full max-w-[200px] sm:max-w-[300px] aspect-square">
            <Image
